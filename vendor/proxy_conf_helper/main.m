...
#import "BRLOptionParser/BRLOptionParser/BRLOptionParser.m"
...
int main(int argc, const char * argv[])
{
    ...
    if (authErr != noErr) {
        ...
        for (NSString *key in [sets allKeys]) {
            ...
            NSString *distType = [dict valueForKeyPath:@"Interface.Type"];
            // NSLog(@"%@", distType);
            BOOL modify = NO;
            if ([networkServiceKeys count] > 0) {
                ...
                [distType isEqualToString:@"PPP"]
                || [distType isEqualToString:@"IPSec"]
                || [distType isEqualToString:@"Ethernet"]
            ) {
                modify = YES;
            }
            ...
            if (modify) {
                ...
                if ([mode isEqualToString:@"auto"]) {
                    ...
                    if (pacURL != nil && portString != nil && socks5ListenAddress != nil) {
                        ...
                        if ((
                            [oldProxies[(NSString *)kCFNetworkProxiesProxyAutoConfigURLString] isEqualToString:pacURL]
